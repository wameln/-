...
<h1 style="margin: 50px 80px; color: darkgray;font-size: 80px; font-family: cursive;">学生管理系统</h1>
<div class="main">
    <h5 class="title" style="font-size: 45px">
    ...
    <form action="check_register" method="post" onsubmit="return check(this)">
        <div class="form-group">
            <input type="email" name="email" class="form-control email" placeholder="请输入邮箱">
